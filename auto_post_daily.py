...
def main():
    ...
    try:
        ...
        logger.info(f"    Regular: {stats['regular_keywords']}")
        logger.info(f"    Ranking: {stats['ranking_keywords']}")
        logger.info(f"  Used Keywords: {stats['used_keywords']}")
        logger.info(f"    Regular: {stats['used_regular_keywords']}")
        logger.info(f"    Ranking: {stats['used_ranking_keywords']}")
        logger.info(f"  Remaining Keywords:")
        logger.info(f"    Regular: {stats['remaining_regular_keywords']}")
        logger.info(f"    Ranking: {stats['remaining_ranking_keywords']}")
